*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VM_FIGASS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VM_FIGASS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VM_FIGASS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VM_FIGASS_EXTRACT
TOTAL = /GICOM/VM_FIGASS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VM_FIGASS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VM_FIGASS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VM_FIGASS_EXTRACT
TOTAL = /GICOM/VM_FIGASS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VM_FIGASS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VM_FIGASS'
...
TOTAL = /GICOM/VM_FIGASS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VM_FIGASS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VM_FIGASS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VM_FIGASS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VM_FIGASS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VM_FIGASS_EXTRACT
TOTAL = /GICOM/VM_FIGASS_TOTAL
