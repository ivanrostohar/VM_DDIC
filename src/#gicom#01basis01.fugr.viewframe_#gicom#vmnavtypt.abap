*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VMNAVTYPT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VMNAVTYPT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVTYPT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VMNAVTYPT_EXTRACT
TOTAL = /GICOM/VMNAVTYPT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVTYPT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VMNAVTYPT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVTYPT_EXTRACT
TOTAL = /GICOM/VMNAVTYPT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VMNAVTYPT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVTYPT'
...
TOTAL = /GICOM/VMNAVTYPT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VMNAVTYPT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VMNAVTYPT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVTYPT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VMNAVTYPT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVTYPT_EXTRACT
TOTAL = /GICOM/VMNAVTYPT_TOTAL
