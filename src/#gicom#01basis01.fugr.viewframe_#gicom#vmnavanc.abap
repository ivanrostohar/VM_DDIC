*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VMNAVANC
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VMNAVANC     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVANC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VMNAVANC_EXTRACT
TOTAL = /GICOM/VMNAVANC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVANC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VMNAVANC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVANC_EXTRACT
TOTAL = /GICOM/VMNAVANC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VMNAVANC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVANC'
...
TOTAL = /GICOM/VMNAVANC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VMNAVANC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VMNAVANC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVANC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VMNAVANC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVANC_EXTRACT
TOTAL = /GICOM/VMNAVANC_TOTAL
