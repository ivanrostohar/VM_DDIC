*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VMNAVTYPE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VMNAVTYPE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVTYPE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VMNAVTYPE_EXTRACT
TOTAL = /GICOM/VMNAVTYPE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVTYPE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VMNAVTYPE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVTYPE_EXTRACT
TOTAL = /GICOM/VMNAVTYPE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VMNAVTYPE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVTYPE'
...
TOTAL = /GICOM/VMNAVTYPE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VMNAVTYPE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VMNAVTYPE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVTYPE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VMNAVTYPE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVTYPE_EXTRACT
TOTAL = /GICOM/VMNAVTYPE_TOTAL
