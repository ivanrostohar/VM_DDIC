*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VMUISCRN
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VMUISCRN     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VMUISCRN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VMUISCRN_EXTRACT
TOTAL = /GICOM/VMUISCRN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMUISCRN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VMUISCRN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMUISCRN_EXTRACT
TOTAL = /GICOM/VMUISCRN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VMUISCRN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VMUISCRN'
...
TOTAL = /GICOM/VMUISCRN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VMUISCRN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VMUISCRN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMUISCRN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VMUISCRN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMUISCRN_EXTRACT
TOTAL = /GICOM/VMUISCRN_TOTAL
