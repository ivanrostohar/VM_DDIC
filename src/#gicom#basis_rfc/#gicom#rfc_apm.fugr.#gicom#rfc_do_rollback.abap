FUNCTION /GICOM/RFC_DO_ROLLBACK.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"----------------------------------------------------------------------
  ...
  TRY.
    ...
    CATCH /gicom/cx_rollback_failed INTO lx_rollback_fail_exception.
      et_return = /gicom/cl_rfc_helper=>exeption_to_bapiret( lx_rollback_fail_exception ).
