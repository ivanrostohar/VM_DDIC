*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VM_CH_RSA
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VM_CH_RSA    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VM_CH_RSA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VM_CH_RSA_EXTRACT
TOTAL = /GICOM/VM_CH_RSA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VM_CH_RSA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VM_CH_RSA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VM_CH_RSA_EXTRACT
TOTAL = /GICOM/VM_CH_RSA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VM_CH_RSA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VM_CH_RSA'
...
TOTAL = /GICOM/VM_CH_RSA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VM_CH_RSA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VM_CH_RSA-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VM_CH_RSA'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VM_CH_RSA-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VM_CH_RSA_EXTRACT
TOTAL = /GICOM/VM_CH_RSA_TOTAL
