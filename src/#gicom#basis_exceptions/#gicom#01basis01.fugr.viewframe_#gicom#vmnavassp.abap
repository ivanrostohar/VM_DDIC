*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VMNAVASSP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VMNAVASSP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVASSP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VMNAVASSP_EXTRACT
TOTAL = /GICOM/VMNAVASSP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVASSP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VMNAVASSP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVASSP_EXTRACT
TOTAL = /GICOM/VMNAVASSP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VMNAVASSP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVASSP'
...
TOTAL = /GICOM/VMNAVASSP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VMNAVASSP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VMNAVASSP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVASSP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VMNAVASSP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVASSP_EXTRACT
TOTAL = /GICOM/VMNAVASSP_TOTAL
