*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VMNAVOBJ
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VMNAVOBJ     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVOBJ'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VMNAVOBJ_EXTRACT
TOTAL = /GICOM/VMNAVOBJ_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVOBJ'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VMNAVOBJ-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVOBJ_EXTRACT
TOTAL = /GICOM/VMNAVOBJ_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VMNAVOBJ-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVOBJ'
...
TOTAL = /GICOM/VMNAVOBJ_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VMNAVOBJ-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VMNAVOBJ-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VMNAVOBJ'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VMNAVOBJ-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VMNAVOBJ_EXTRACT
TOTAL = /GICOM/VMNAVOBJ_TOTAL
