*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/GICOM/VM_MEFCNS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/GICOM/VM_MEFCNS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/GICOM/VM_MEFCNS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /GICOM/VM_MEFCNS_EXTRACT
TOTAL = /GICOM/VM_MEFCNS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/GICOM/VM_MEFCNS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/GICOM/VM_MEFCNS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VM_MEFCNS_EXTRACT
TOTAL = /GICOM/VM_MEFCNS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/GICOM/VM_MEFCNS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/GICOM/VM_MEFCNS'
...
TOTAL = /GICOM/VM_MEFCNS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/GICOM/VM_MEFCNS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/GICOM/VM_MEFCNS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/GICOM/VM_MEFCNS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/GICOM/VM_MEFCNS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /GICOM/VM_MEFCNS_EXTRACT
TOTAL = /GICOM/VM_MEFCNS_TOTAL
